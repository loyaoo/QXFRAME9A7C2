...
function create(source, overrides) {
  ...
  function setDraftDisplayValue(value) { opts.draftDisplayValue = stringValue(value); syncView(); return api; }
  ...
  api = Object.freeze({
    ...
    setHasValue: setHasValue, setExpanded: setExpanded, setDraftDisplayValue: setDraftDisplayValue, setDraftVisual: setDraftVisual,
