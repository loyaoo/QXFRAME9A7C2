...
function clearAllowed(options, capabilities) { return InteractionPolicy.resolve(InteractionPolicy.stateFromOptions(options), Utils.assignOwn({ clearable:true }, capabilities || {})).clearable; }
