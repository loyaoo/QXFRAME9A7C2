...
const cc=Cascader.create({document,container:host(),items:[{key:'b',value:'b',label:'B'}],value:'b',controlled:true});const cci=cc.getControl().getFocusElement();cci.focus();key(cci,'ArrowDown');key(cci,'Enter');a(cc.getState().value==='b','cascader controlled value remains external');cc.destroy();
